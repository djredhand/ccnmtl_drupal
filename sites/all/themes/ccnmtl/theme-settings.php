...
function ccnmtl_form_system_theme_settings_alter(&$form, $form_state) {
  global $base_url;
  ...
  $form['st_container'] = array(
    '#type' => 'fieldset',
    '#title' => t('ccnmtl theme settings'),
    '#description' => t('Use these settings to enhance the appearance of your ccnmtl theme.'),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
  );
